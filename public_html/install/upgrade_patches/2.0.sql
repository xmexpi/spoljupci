...
VALUES ('', 'global', 'Catalog Template Settings', '', 'site_template_site_settings', '{"product_modal_window":"1","sidebar_parallax_effect":"1","cookie_acceptance":"1"}', 'smalltext()', 0, NOW(), NOW());
-- --------------------------------------------------------
...
-- --------------------------------------------------------
UPDATE `lc_settings` SET `value` = 'default.site' WHERE `key` = 'site_template_site';
-- --------------------------------------------------------
