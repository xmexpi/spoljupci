        ...
        <ul>
          ...
          <li>Extensions
            <ul>
              ...
              <li>ioncube <?php echo extension_loaded('ionCube Loader') ? '<span class="ok">[OK]</span>' : '<span class="error">[Missing]</span>'; ?></li>
...
<form name="installation_form" method="post" action="install.php">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-6">
      ...
      <select class="form-control" name="db_collation" required="required">
        <option selected="selected">utf8_bin</option>
  ...
  <div class="row">
    <div class="form-group col-md-6">
      ...
      <input class="form-control" name="site_name" type="text" value="My Site" required="required" />
    </div>

    <div class="form-group col-md-6">
      <label>Site Email</label>
      <input class="form-control" name="site_email" type="text" value="info@xmexpi.com" required="required" />
    </div>
  </div>
  ...
  <p class="text-center">
    This software is licensed under <a href="https://xmexpi.com/" target="blank">Creative Commons BY-ND 4.0</a>.
  </p>
