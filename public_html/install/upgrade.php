  ...
  try {
    ...
    foreach ($supported_versions as $version) {
      ...
      if (file_exists(__DIR__ . '/upgrade_patches/' . $version . '.sql')) {
        ...
        $sql = str_replace('`xp_', '`' . DB_TABLE_PREFIX, $sql);
      ...
      database::query(
        "update " . str_replace('`xp_', '`' . DB_TABLE_PREFIX, '`xp_settings`') . "
    ...
    if (!empty($_REQUEST['development_type']) && $_REQUEST['development_type'] == 'advanced') {
      ...
      $files_to_delete = array(
        FS_DIR_APP . 'includes/templates/default.site/css/app.css',
        FS_DIR_APP . 'includes/templates/default.site/css/checkout.css',
        FS_DIR_APP . 'includes/templates/default.site/css/framework.css',
        FS_DIR_APP . 'includes/templates/default.site/css/printable.css',
      );
      ...
      $files_to_delete = array(
        FS_DIR_APP . 'includes/templates/default.site/css/*.min.css',
        FS_DIR_APP . 'includes/templates/default.site/css/*.min.css.map',
        FS_DIR_APP . 'includes/templates/default.site/js/*.min.js',
        FS_DIR_APP . 'includes/templates/default.site/js/*.min.js.map',
        FS_DIR_APP . 'includes/templates/default.site/less/',
      );
      ...
      foreach (glob(FS_DIR_APP . 'includes/templates/default.site/layouts/*.inc.php') as $file) {
