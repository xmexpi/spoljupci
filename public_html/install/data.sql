...
-- --------------------------------------------------------
INSERT INTO `xp_countries` (`id`, `status`, `name`, `domestic_name`, `iso_code_1`, `iso_code_2`, `iso_code_3`, `tax_id_format`, `address_format`, `postcode_format`, `postcode_required`, `language_code`, `currency_code`, `phone_code`, `date_updated`, `date_created`) VALUES
...
(5, 1, 'Andorra', '', '020', 'AD', 'AND', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', 'AD[0-9]{3}', 0, 'ca', 'EUR', '376', NOW(), NOW()),
...
(36, 1, 'Cambodia', '', '116', 'KH', 'KHM', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{5}', 0, 'km', 'KHR', '855', NOW(), NOW()),
(37, 1, 'Cameroon', '', '120', 'CM', 'CMR', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '', 0, 'en', 'XAF', '237', NOW(), NOW()),
(38, 1, 'Canada', '', '124', 'CA', 'CAN', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[ABCEGHJKLMNPRSTVXY][0-9][ABCEGHJ-NPRSTV-Z][ ]?[0-9][ABCEGHJ-NPRSTV-Z][0-9]', 0, 'en', 'CAD', '1', NOW(), NOW()),
(39, 1, 'Cape Verde', '', '132', 'CV', 'CPV', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{4}', 0, 'pt', 'CVE', '238', NOW(), NOW()),
...
(44, 1, 'China', '', '156', 'CN', 'CHN', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{6}', 0, 'zh', 'CNY', '86', NOW(), NOW()),
...
(80, 1, 'Georgia', '', '268', 'GE', 'GEO', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{4}', 0, 'ka', 'GEL', '995', NOW(), NOW()),
(81, 1, 'Germany', '', '276', 'DE', 'DEU', '^(DE)?[0-9]{9}$', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{5}', 0, 'de', 'EUR', '49', NOW(), NOW()),
...
(108, 1, 'Jordan', '', '400', 'JO', 'JOR', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{5}', 0, 'ar', 'JOD', '962', NOW(), NOW()),
(109, 1, 'Kazakhstan', '', '398', 'KZ', 'KAZ', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{6}', 0, 'kk', 'KZT', '7', NOW(), NOW()),
(110, 1, 'Kenya', '', '404', 'KE', 'KEN', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{5}', 0, 'en', 'KES', '254', NOW(), NOW()),
...
(113, 1, 'Korea, Republic of', '', '410', 'KR', 'KOR', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{3}[\\-][0-9]{3}', 0, 'ko', 'KRW', '82', NOW(), NOW()),
(114, 1, 'Kuwait', '', '414', 'KW', 'KWT', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{5}', 0, 'ar', 'KWD', '965', NOW(), NOW()),
(115, 1, 'Kyrgyzstan', '', '417', 'KG', 'KGZ', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{6}', 0, 'ky', 'KGS', '996', NOW(), NOW()),
(116, 1, 'Lao People\'s Democratic Republic', '', '418', 'LA', 'LAO', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{5}', 0, 'lo', 'LAK', '856', NOW(), NOW()),
(117, 1, 'Latvia', '', '428', 'LV', 'LVA', '^(LV)?[0-9]{11}$', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{4}', 0, 'lv', 'LVL', '371', NOW(), NOW()),
(118, 1, 'Lebanon', '', '422', 'LB', 'LBN', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '([0-9]{4}([ ]?[0-9]{4})?)?', 0, 'ar', 'LBP', '961', NOW(), NOW()),
(119, 1, 'Lesotho', '', '426', 'LS', 'LSO', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{3}', 0, 'en', 'LSL', '266', NOW(), NOW()),
(120, 1, 'Liberia', '', '430', 'LR', 'LBR', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{4}', 0, 'en', 'LRD', '231', NOW(), NOW()),
...
(130, 1, 'Maldives', '', '462', 'MV', 'MDV', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{5}', 0, 'dv', 'MVR', '960', NOW(), NOW()),
...
(154, 1, 'Nicaragua', '', '558', 'NI', 'NIC', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '(([0-9]{4}-)?[0-9]{3}-[0-9]{3}(-[0-9]{1})?)?', 0, 'es', 'NIO', '505', NOW(), NOW()),
(155, 1, 'Niger', '', '562', 'NE', 'NER', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{4}', 0, 'fr', 'XOF', '227', NOW(), NOW()),
(156, 1, 'Nigeria', '', '566', 'NG', 'NGA', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '([0-9]{6})?', 0, 'en', 'NGN', '234', NOW(), NOW()),
...
(159, 1, 'Northern Mariana Islands', '', '580', 'MP', 'MNP', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '9695[012]([ \\-][0-9]{4})?', 0, 'tl', 'USD', '167', NOW(), NOW()),
(160, 1, 'Norway', '', '578', 'NO', 'NOR', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{4}', 0, 'nb', 'NOK', '47', NOW(), NOW()),
(161, 1, 'Oman', '', '512', 'OM', 'OMN', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '(PC )?[0-9]{3}', 0, 'ar', 'OMR', '968', NOW(), NOW()),
(162, 1, 'Pakistan', '', '586', 'PK', 'PAK', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{5}', 0, 'ur', 'PKR', '92', NOW(), NOW()),
...
(229, 1, 'Venezuela', '', '862', 'VE', 'VEN', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{4}', 0, 'es', 'VEF', '58', NOW(), NOW()),
...
(232, 1, 'Virgin Islands (U.S.)', '', '850', 'VI', 'VIR', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '008(([0-4][0-9])|(5[01]))([ \\-][0-9]{4})?', 0, 'en', 'USD', '134', NOW(), NOW()),
(233, 1, 'Wallis and Futuna Islands', '', '876', 'WF', 'WLF', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '986[0-9]{2}', 0, 'fr', 'XPF', '681', NOW(), NOW()),
...
(238, 1, 'Zambia', '', '894', 'ZM', 'ZMB', '', '%company\r\n%firstname %lastname\r\n%address1\r\n%address2\r\n%postcode %city\r\n%zone_name\r\n%country_name', '[0-9]{5}', 0, 'en', 'ZMW', '260', NOW(), NOW()),
...
-- --------------------------------------------------------
INSERT INTO `xp_settings_groups` (`key`, `name`, `description`, `priority`) VALUES
('site_info', 'Site Info', 'Site information', 10),
('defaults', 'Defaults', 'Site default settings', 20),
('email', 'Email', 'Email and SMTP', 30),
('listings', 'Listings', 'Settings for the catalog listing', 40),
('customer_details', 'Customer Details', 'Settings for the site listing', 45),
...
('site_info', 'global', 'Site Postcode', 'The postcode of your site.', 'site_postcode', '', 'text()', 18, NOW(), NOW()),
('site_info', 'global', 'Site Time Zone', 'The site\'s time zone.', 'site_timezone', '{SITE_TIME_ZONE}', 'timezone()', 19, NOW(), NOW()),
('site_info', 'local', 'Site Language', 'The spoken language of your organization.', 'site_language_code', 'en', 'language()', 20, NOW(), NOW()),
('site_info', 'global', 'Site Currency', 'The currency which all prices conform to.', 'site_currency_code', 'USD', 'currency()', 21, NOW(), NOW()),
('site_info', 'global', 'Site Weight Class', 'The preferred weight class.', 'site_weight_class', 'kg', 'weight_class()', 22, NOW(), NOW()),
('site_info', 'global', 'Site Length Class', 'The preferred length class.', 'site_length_class', 'cm', 'length_class()', 23, NOW(), NOW()),
('defaults', 'global', 'Default Language', 'The default language, if not identified.', 'default_language_code', 'en', 'language()', 10, NOW(), NOW()),
('defaults', 'global', 'Default Currency', 'The default currency, if not identified.', 'default_currency_code', 'USD', 'currency()', 11, NOW(), NOW()),
('defaults', 'global', 'Default Country', 'The default country, if not otherwise set.', 'default_country_code', '{SITE_COUNTRY_CODE}', 'country()', 12, NOW(), NOW()),
('defaults', 'global', 'Default Zone', 'The default zone, if not otherwise set.', 'default_zone_code', '', 'zone("default_country_code")', 13, NOW(), NOW()),
('defaults', 'global', 'Default Display Prices Including Tax', 'Display prices including tax by default.', 'default_display_prices_including_tax', '1', 'toggle()', 15, NOW(), NOW()),
('defaults', 'global', 'Maintenance Mode', 'Setting the site in maintenance mode will prevent users from browsing your site.', 'maintenance_mode', '0', 'toggle()', 2, NOW(), NOW()),
('defaults', 'global', 'Catalog Only Mode', 'Disables the cart and checkout features leaving only a browsable catalog.', 'catalog_only_mode', '0', 'toggle("t/f")', 1, NOW(), NOW()),
('defaults', 'local', 'Items Per Page', 'The number of items to be displayed per page.', 'items_per_page', '20', 'number()', 10, NOW(), NOW()),
('defaults', 'local', 'Data Table Rows', 'The number of data table rows to be displayed per page.', 'data_table_rows_per_page', '25', 'text()', 11, NOW(), NOW()),
('defaults', 'local', 'Display Stock Count', 'Show the available amount of products in stock.', 'display_stock_count', '1', 'toggle()', 12, NOW(), NOW()),
('defaults', 'local', 'Cheapest Shipping', 'Display the cheapest shipping cost on product page.', 'display_cheapest_shipping', '1', 'toggle()', 13, NOW(), NOW()),
('defaults', 'local', 'Max Age for New Products', 'Display the "New" sticker for products less than the given age. E.g. 1 month or 14 days', 'new_products_max_age', '1 month', 'text()', 14, NOW(), NOW()),
('defaults', 'local', 'Similar Products Box: Number of Items', 'The maximum number of items to be displayed in the box.', 'box_similar_products_num_items', '8', 'number()', 15, NOW(), NOW()),
('defaults', 'local', 'Recently Viewed Products Box: Number of Items', 'The maximum number of items to be displayed in the box.', 'box_recently_viewed_products_num_items', '6', 'number()', 16, NOW(), NOW()),
('defaults', 'local', 'Latest Products Box: Number of Items', 'The maximum number of items to be displayed in the box.', 'box_latest_products_num_items', '8', 'number()', 17, NOW(), NOW()),
('defaults', 'local', 'Popular Products Box: Number of Items', 'The maximum number of items to be displayed in the box.', 'box_popular_products_num_items', '8', 'number()', 18, NOW(), NOW()),
('defaults', 'local', 'Campaign Products Box: Number of Items', 'The maximum number of items to be displayed in the box.', 'box_campaign_products_num_items', '4', 'number()', 19, NOW(), NOW()),
('defaults', 'local', 'Also Purchased Products Box: Number of Items', 'The maximum number of items to be display in the box.', 'box_also_purchased_products_num_items', '4', 'number()', 20, NOW(), NOW()),
('defaults', 'local', 'Auto Decimals', 'Don\'t show decimals for integers. Will turn 99.00 into 99 but leave 99.99.', 'auto_decimals', '1', 'toggle("e/d")', 21, NOW(), NOW()),
('defaults', 'global', 'Show Product Count In Category Tree', 'Show the number of products inside each category in the category tree.', 'category_tree_product_count', '0', 'toggle("y/n")', 22, NOW(), NOW()),
...
('email', 'local', 'SMTP Username', 'Username for SMTP authentication.', 'smtp_username', '', 'text()', 13, NOW(), NOW()),
('email', 'local', 'SMTP Password', 'Password for SMTP authentication.', 'smtp_password', '', 'password()', 14, NOW(), NOW()),
('customer_details', 'global', 'Regional Settings Screen', 'Enables the regional settings screen upon first visit.', 'regional_settings_screen', '0', 'toggle("e/d")', 10, NOW(), NOW()),
('customer_details', 'global', 'Enable Customer Accounts', 'Allow customers to create an account and sign in.', 'accounts_enabled', '1', 'toggle("e/d")', 11, NOW(), NOW()),
...
('images', 'local', 'Category Images: Aspect Ratio', 'The aspect ratio of the category thumbnails', 'category_image_ratio', '3:2', 'select("1:1","2:3","3:2","3:4","4:3","16:9")', '10', NOW(), NOW()),
...
('images', 'local', 'Product Images: Watermark', 'Watermark product images with the site logo.', 'product_image_watermark', '0', 'toggle("y/n")', '34', NOW(), NOW()),
('images', 'local', 'Downsample', 'Downsample large uploaded images to best fit within the given dimensions of "width,height" or leave empty. Default: 2048,2048', 'image_downsample_size', '2048,2048', 'text()', '34', NOW(), NOW()),
('images', 'local', 'Image Quality', 'The JPEG quality for uploaded images (0-100). Default: 90', 'image_quality', '90', 'number()', '40', NOW(), NOW()),
...
('advanced', 'global', 'Site Configuration Key', 'The site\'s configuration key.', 'site_configuration', '{SITE_CONFIGURATION}', 'text()', 12, NOW(), NOW()),
...
('', 'global', 'Site Template', '', 'site_template_site', 'tema1.site', 'template("site")', 0, NOW(), NOW()),
...
(6, 1, 2, 'DJ Demo','team/default.jpg', 'DJ Demo', 1, NULL, NULL, NOW(), NOW()),
(7, 1, 2, 'DJ Demo','team/default.jpg', 'DJ Demo', 1, NULL, NULL, NOW(), NOW()),
(8, 1, 2, 'DJ Demo','team/default.jpg', 'DJ Demo', 1, NULL, NULL, NOW(), NOW()),
