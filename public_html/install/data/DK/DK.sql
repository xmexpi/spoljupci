...
-- --------------------------------------------------------
ALTER TABLE `xp_translations` ADD `text_da` text NOT NULL AFTER `text_en`;
-- --------------------------------------------------------
...
-- --------------------------------------------------------
ALTER TABLE `xp_products_prices` ADD `DKK` DECIMAL(11,4) NOT NULL;
-- --------------------------------------------------------
ALTER TABLE `xp_products_campaigns` ADD `DKK` DECIMAL(11,4) NOT NULL;
-- --------------------------------------------------------
ALTER TABLE `xp_products_options_values` ADD `DKK` DECIMAL(11,4) NOT NULL;
-- --------------------------------------------------------
UPDATE `xp_settings` SET `value` = 'DKK' WHERE `key` in ('site_currency_code', 'default_currency_code');
-- --------------------------------------------------------
UPDATE `xp_currencies` SET `value` = 6.3511 WHERE `code` = 'USD' LIMIT 1;
-- --------------------------------------------------------
UPDATE `xp_currencies` SET `value` = 7.4499 WHERE `code` = 'EUR' LIMIT 1;
-- --------------------------------------------------------
