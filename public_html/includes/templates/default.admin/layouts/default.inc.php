  ...
  <div id="sidebar" class="hidden-print">
    ...
    <div id="logotype">
      <a href="<?php echo document::href_link(WS_DIR_ADMIN); ?>">
        <img class="center-block img-responsive" src="<?php echo WS_DIR_TEMPLATE; ?>images/logotype.svg" alt="<?php echo settings::get('site_name'); ?>" />
      </a>
    </div>
    ...
    <div id="copyright" class="text-center">Copyright &copy; <?php echo date('2021-Y'); ?><br />
      <a href="https://www.xmexpi.com" target="_blank">www.xmexpi.com</a>
    </div>
  </div>
...
-->
      ...
      <li>
        <a class="help" href="https://wiki.xmexpi.com/" target="_blank" title="<?php echo language::translate('title_help', 'Help'); ?>">
