...
<h1><span><?php echo language::translate('xmexpi_login', 'Login'); ?></span></h1>
<div id="content">
  {snippet:notices}
  {snippet:breadcrumbs}
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <section id="box-login-create" class="box">
        ...
        <p><a class="btn btn-default" href="<?php echo document::href_ilink('create_account'); ?>"><?php echo language::translate('title_register_now', 'Register Now'); ?></a>
        <p>
      </section>
    </div>
  </div>
