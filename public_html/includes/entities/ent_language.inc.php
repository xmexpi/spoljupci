  ...
  class ent_language {
    ...
    public function save() {
      ...
      if (empty($this->data['status']) && $this->data['code'] == settings::get('site_language_code')) {
        throw new Exception(language::translate('error_cannot_disable_site_language', 'You must change the store language before disabling it.'));
      }
    ...
    public function delete() {
      ...
      if ($this->data['code'] == settings::get('site_language_code')) {
        throw new Exception(language::translate('error_cannot_delete_site_language', 'You must change the store language before it can be deleted.'));
      }
