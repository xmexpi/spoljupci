  ...
  class ent_country {
    ...
    public function save() {
      ...
      if (empty($this->data['status']) && $this->data['iso_code_2'] == settings::get('site_country_code')) {
        throw new Exception(language::translate('error_cannot_disable_site_country', 'You must change the store country before disabling it.'));
      }
    ...
    public function delete() {
      ...
      if ($this->data['code'] == settings::get('site_country_code')) {
        throw new Exception(language::translate('error_cannot_delete_site_country', 'You must change the store country before it can be deleted.'));
      }
