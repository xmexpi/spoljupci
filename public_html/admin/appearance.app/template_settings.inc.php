...
// Get template settings structure
  $settings = include vmod::check(FS_DIR_APP . 'includes/templates/' . settings::get('site_template_site') .'/config.inc.php');
  if (!is_array($settings)) include vmod::check(FS_DIR_APP . 'includes/templates/' . settings::get('site_template_site') .'/config.inc.php'); // Backwards compatibility

  if (empty($settings)) $settings = array();

// Insert template settings
  $saved_settings = json_decode(settings::get('site_template_site_settings'), true);
        ...
        <tbody>
          ...
          <tr>
            <td style="white-space: normal;">
              <u><?php echo language::translate(settings::get('site_template_site').':title_'.$setting['key'], $setting['title']); ?></u><br />
              <?php echo language::translate(settings::get('site_template_site').':description_'.$setting['key'], $setting['description']); ?>
            </td>
          ...
          <?php } else { ?>
          <tr>
            <td><?php echo language::translate(settings::get('site_template_site').':title_'.$setting['key'], $setting['title']); ?></td>
            <td>
