    ...
    try {
      ...
      foreach (array_keys($_POST['currencies']) as $currency_code) {
        ...
        if (!empty($_POST['disable']) && $currency_code == settings::get('site_currency_code')) {
          throw new Exception(language::translate('error_cannot_disable_site_currency', 'You cannot disable the store currency'));
        }
      ...
      <table class="table table-striped table-hover data-table">
        <thead>
          <tr>
            ...
            <th><?php echo language::translate('title_site_currency', 'Site Currency'); ?></th>
