  ...
  if (!empty($_POST['reset_password'])) {
    ...
    // Process
      ...
      if (empty($_REQUEST['reset_token'])) {
        ...
        $message = strtr(language::translate('email_body_reset_password', "You recently requested to reset your password for %site_name. If you did not request a password reset, please ignore this email. Visit the link below to reset your password:\r\n\r\n%link\r\n\r\nReset Token: %token"), $aliases);
